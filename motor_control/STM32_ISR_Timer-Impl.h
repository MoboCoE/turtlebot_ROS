...
int STM32_ISR_Timer::setupTimer(unsigned long d, void* f, void* p, bool h, unsigned n) 
{
  int freeTimer;
...
int STM32_ISR_Timer::setTimer(unsigned long d, timerCallback_p f, void* p, unsigned n) 
{
